...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('🌐 Support', url='https://t.me/FF_Bots')
            ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 Updates', url='https://t.me/FF_OTT_Updates1')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('🌐 Support', url=f'https://t.me/FF_Bots')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
